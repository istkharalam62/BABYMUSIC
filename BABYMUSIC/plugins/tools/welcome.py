...
import asyncio
import time
from BABYMUSIC.utils.database import add_served_chat
...
from BABYMUSIC.utils.database import get_assistant, is_active_chat
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("BABYMUSIC/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((500, 500))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('BABYMUSIC/assets/font.ttf', size=60)
    welcome_font = ImageFont.truetype('BABYMUSIC/assets/font.ttf', size=60)
